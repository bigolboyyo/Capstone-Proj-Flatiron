...
law_one_url = URI.parse("https://ik.imagekit.io/bigboyyo/broken_machines_eH3ErgNUT.png?ik-sdk-version=javascript-1.4.3&updatedAt=1665205761212")
law_one_filename = File.basename(law_one_url.path)
law_one_file = URI.open(law_one_url)
lawyer_init.storyline_img.attach(io: law_one_file, filename: law_one_filename)
...
law_two_url = URI.parse("https://ik.imagekit.io/bigboyyo/desert_1zbifyZEO.jpg?ik-sdk-version=javascript-1.4.3&updatedAt=1665216221736")
law_two_filename = File.basename(law_two_url.path)
law_two_file = URI.open(law_two_url)
lawyer_two.storyline_img.attach(io: law_two_file, filename: law_two_filename)
# # Choice three ->

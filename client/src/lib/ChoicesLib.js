...
const lawBatchTwo = {
  ...
  choice_three: {
    ...
    next_choice: "CactusWater",
    //next nav: 8
  },
  choice_four: {
    choice_text: "Go back the way you came",
    next_choice: "PostSunReturn",
    //next nav: 9
  },
};
...
const lawBatchNineteen = {
  ...
  choice_four: {
    choice_text: "S U R P R I S E",
    next_choice: "EasterEgg",
  },
};

const lawBatchTwenty = {
  choice_one: {
    choice_text: "Start walking towards the sun",
    next_choice: "SunStriver",
    //next nav: 2
...
const lawBatchTwentyOne = {
  choice_one: {
    choice_text: "GAME OVER",
    next_choice: "DemoEnd",
    //next nav: 2
  },
};
...
export const choices = {
  ...
  laws_nineteen: Object.values(Object.values(lawBatchNineteen)),

  laws_twenty: Object.values(Object.values(lawBatchTwenty)),

  laws_twenty_one: Object.values(Object.values(lawBatchTwentyOne)),
};

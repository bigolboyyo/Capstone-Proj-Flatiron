...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "robot_adventure_production"
  ...
  config.imagekit = {
    private_key: "private_jNGY5wl0zDAHJ6xsybNFtpPrFtI=",
    public_key: "public_bQ/QeNEojdJkfBgdHhFJiqVcygM=",
